            ...
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    <tr v-for="product in products" :key="product.id">
                        <td>
                            <img  v-if="product.product_image != null" v-bind:src="'images/products/' + product.product_image" width="50">
                            <img  v-if="product.product_image == null" src="images/products/noImg.jpg" width="50">
                            </td>
                        <td>{{ product.product_name }}</td>
                        <td>{{ product.product_price }}</td>
                        <td>{{ product.product_qty }}</td>
                        <td>{{ product.created_at | moment("DD/MM/YYYY") }}</td>
